...
$slogin_user = "slogin651";
#Senha
$slogin_pass = "gingerbread";
...
//Rotina de configura��o da tabela
	...
	elseif(!mysqli_query("SELECT * FROM slogin_users")){
...
$res
<div class='cprg'><h5>&copy <a href='http://www.sandrinhoinfo.com.br/?ref=Slogin65'>Sandrinho Info</a> - <a href='../notas.php'>Notas da vers�o</a> - <a href='../'>P�gina Inicial</a> - <a href='./'>Configura��es do Slogin</a></h5></div>
</body>
</html>";
#Envia a p�gina
echo $html;
